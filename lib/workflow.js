...
export const BASE_TRANSITIONS = {
  Reported: ["AI Pre-Validation"],
  "AI Pre-Validation": ["Community Review"],
  "Community Review": ["Verified"],
  Verified: ["Assigned"],
  Assigned: ["In Progress"],
  "In Progress": ["Work Uploaded"],
  "Work Uploaded": ["AI Resolution Validation"],
  "AI Resolution Validation": ["Manager Review", "Completed"],
  "Manager Review": ["Completed"],
  Completed: ["User Confirmation"],
...
export function canTransition(
  ...
  if (currentState === "AI Resolution Validation") {
    if (requiresManagerReview) {
      return nextState === "Manager Review";
    }
...
export function getNextState(currentState, requiresManagerReview = false) {
  if (currentState === "AI Resolution Validation") {
    return requiresManagerReview ? "Manager Review" : "Completed";
  }
